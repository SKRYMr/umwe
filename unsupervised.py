...
"""
COMMAND TO RUN (LIMITING VOCABULARY TO 400K TOKENS IMPROVES PERFORMANCE)
python unsupervised.py --src_langs it fr es de pt --tgt_lang en --src_embs data/fasttext-vectors/skipgram_mixed_dataset_50w50c_300dim.bin data/fasttext-vectors/skipgram_reprocessed-frwikidump-fil_300dim.bin data/fasttext-vectors/skipgram_reprocessed-eswikidump-fil_300dim.bin data/fasttext-vectors/skipgram_reprocessed-dewikidump-fil_300dim.bin data/fasttext-vectors/skipgram_reprocessed-ptwikidump-fil_300dim.bin --tgt_emb data/fasttext-vectors/skipgram_reprocessed-enwikidump-fil_300dim.bin --device cuda --export bin --max_vocab 400000 --exp_name [folder_name]
"""
...
parser.add_argument("--exclusion_list", type=str, default="", help="Words to exclude from vocabulary during training")
# mapping
...
assert params.exclusion_list == "" or os.path.isfile(params.exclusion_list)
